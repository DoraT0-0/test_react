...
function App() {
	...
	return <div>
		<input value={value1} type="2024-03-14" onChange={event => setValue1(event.target.value)} /> 
		<input value={value2} type="2024-03-14" onChange={event => setValue2(event.target.value)} /> 
